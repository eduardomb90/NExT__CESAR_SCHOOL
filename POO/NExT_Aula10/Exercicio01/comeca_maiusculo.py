from decorators import medidor, logar_execução, meu_decorator
...
if __name__ == '__main__':
    ...
    Util.comeca_maiusculo1(strings_de_teste * 10)
    Util.comeca_maiusculo2(strings_de_teste * 10)
    Util.comeca_maiusculo3(strings_de_teste * 10)
    Util.comeca_maiusculo4(strings_de_teste * 10)
    Util.comeca_maiusculo5(strings_de_teste * 10)
    Util.comeca_maiusculo6(strings_de_teste * 10)